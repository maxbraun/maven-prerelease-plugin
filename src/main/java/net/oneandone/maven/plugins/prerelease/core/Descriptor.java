...
public class Descriptor {
    ...
    private final net.oneandone.maven.plugins.prerelease.util.Scm scm;
    ...
    public static Descriptor load(Target target) throws IOException {
        ...
        return new Descriptor(get(properties, PRERELEASE), target.getRevision(), get(properties, SVN_ORIG), get(properties, SVN_TAG),
                ...
                getProperties(properties, DEPLOY_PROPERTIES), target.scm());
    }

    public static Descriptor create(String prerelease, MavenProject mavenProject, long revision, net.oneandone.maven.plugins.prerelease.util.Scm.Credentials credentials)
        ...
        net.oneandone.maven.plugins.prerelease.util.Scm scm = net.oneandone.maven.plugins.prerelease.util.Scm.create(mavenProject, credentials);
    ...
    public static Descriptor checkedCreate(World world, String prerelease, MavenProject mavenProject, long revision, boolean allowSnapshots, boolean allowPrereleaseSnapshots,
                                           net.oneandone.maven.plugins.prerelease.util.Scm scm)
        ...
        return create(prerelease, mavenProject, revision, scm.credentials()).check(world, mavenProject, allowSnapshots, allowPrereleaseSnapshots);
    }
    ...
    public Descriptor(String prerelease, long revision, String svnOrig, String svnTag, Project project, String deployRepository,
                      boolean deployPluginMetadata, String previous, String next, Map<String, String> deployProperties, net.oneandone.maven.plugins.prerelease.util.Scm scm) {
        this.scm = scm;
        if (svnOrig.endsWith("/")) {
    ...
    public Descriptor check(World world, MavenProject mavenProject, boolean allowSnapshots, boolean allowPrereleaseSnapshots)
        ...
        if (scm.exists(world.getTemp(), svnTag)) {
